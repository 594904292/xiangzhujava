...
public class ListConvenienceActivity extends FragmentActivity implements TabHost.OnTabChangeListener{
	...
	private Class fragmentArray[] = {FragmentConvenience2.class, FragmentConvenience1.class};

	private String mTextviewArray[] = { "附近商家","公共电话"};
	...
	private void initView()
	{
		...
		right_image.setOnClickListener(new View.OnClickListener () {
			...
			public void onClick(View v) {
				...
				Intent intent=new Intent(ListConvenienceActivity.this,SearchActivity.class);
