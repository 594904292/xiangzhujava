...
public class InfoPlActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lstv.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				Intent Intent1=null;
				Intent1 = new Intent(InfoPlActivity.this, ViewActivity.class);
		...
		viewhistorybtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				T.showShort(myapplication,"无评论记录");
			}
		});
	...
	private void initView() {
		...
		right_image.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(InfoPlActivity.this,SearchActivity.class);
	...
	private void getData() {
		...
		String target=myapplication.getlocalhost()+"getplinfo.php?userid="+myapplication.getUserId();
				...
				/*	}else {
					...
					if(dataList.get(position).get("icon").toString().trim().length()>0)
					{
						...
						if(arr.length>0) {
							...
							LinearLayout m_LinearLayout = new LinearLayout(InfoPlActivity.this);
							...
							for (int i = 0; i < arr.length; i++) {
								ImageViewSubClass image = new ImageViewSubClass (InfoPlActivity.this);
