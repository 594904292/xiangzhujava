package com.bbxiaoqu.comm.widget;
...
import com.bbxiaoqu.comm.tool.TimeUtil;
...
public class NewAutoListView extends ListView implements OnScrollListener {
	...
	public NewAutoListView(Context context) {
		super(context);
		initView(context);
	}

	public NewAutoListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public NewAutoListView(Context context, AttributeSet attrs, int defStyle) {
